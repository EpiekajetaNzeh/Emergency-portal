...
<!DOCTYPE html>
<head>
<title> New Ambulance Request | Administrative Panel</title>
...
$ret=mysqli_query($con,"select * from  tblambulancehiring  where (tblambulancehiring.Status is null or tblambulancehiring.Status='')");
$cnt=1;
